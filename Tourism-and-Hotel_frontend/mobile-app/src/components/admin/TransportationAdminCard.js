...
export function TransportationAdminCard({
  vehicle,
  deleting = false,
  onView,
  onEdit,
        ...
        <View style={styles.previewCopy}>
          <View style={styles.headerRow}>
            <View style={styles.titleWrap}>
              ...
              <Text style={styles.subtitle}>ID {vehicle.shortId}</Text>
            </View>
          ...
          <InfoRow label="Driver" value={vehicle.driverName || 'Not assigned'} />
          <InfoRow label="Seats" value={vehicle.capacityLabel} />
